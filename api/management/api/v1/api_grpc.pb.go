...
const (
	Api_CreateApi_FullMethodName = "/api.management.api.Api/CreateApi"
	Api_UpdateApi_FullMethodName = "/api.management.api.Api/UpdateApi"
	Api_DeleteApi_FullMethodName = "/api.management.api.Api/DeleteApi"
	Api_GetApi_FullMethodName    = "/api.management.api.Api/GetApi"
	Api_DebugApi_FullMethodName  = "/api.management.api.Api/DebugApi"
...
func (c *apiClient) DebugApi(ctx context.Context, in *DebugApiRequest, opts ...grpc.CallOption) (*DebugApiReply, error) {
	out := new(DebugApiReply)
	err := c.cc.Invoke(ctx, Api_DebugApi_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedApiServer) DebugApi(context.Context, *DebugApiRequest) (*DebugApiReply, error) {
...
func _Api_DebugApi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DebugApiRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServer).DebugApi(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Api_DebugApi_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServer).DebugApi(ctx, req.(*DebugApiRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Api_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.management.api.Api",
	...
	Metadata: "api/management/api/v1/api.proto",
}
