...
func NewOptionsWithApply(opts ...Option) Options {
	opt := NewOptions()
	opt.Apply(opts...)
	return opt
}
...
func WithTracerProvider(provider trace.TracerProvider, traceName string) Option {
	return func(o *Options) {
