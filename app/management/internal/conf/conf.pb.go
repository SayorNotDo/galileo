...
type Service struct {
	...
	Project *Service_Project `protobuf:"bytes,1,opt,name=project,proto3" json:"project,omitempty"`
...
func (x *Service) GetProject() *Service_Project {
	if x != nil {
		return x.Project
	}
	return nil
...
func (x *Service_Project) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Service_Project) ProtoMessage() {}

func (x *Service_Project) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Service_Project.ProtoReflect.Descriptor instead.
func (*Service_Project) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Service_Project) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0xb9, 0x01, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x35, 0x0a, 0x07,
	...
	0x65, 0x63, 0x74, 0x12, 0x2c, 0x0a, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x65, 0x1a, 0x25, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x1a, 0x0a, 0x08,
	0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x1a, 0x22, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65,
	...
	0x27, 0x5a, 0x25, 0x67, 0x61, 0x6c, 0x69, 0x6c, 0x65, 0x6f, 0x2f, 0x6d, 0x61, 0x6e, 0x61, 0x67,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Service_Project)(nil),     // 11: kratos.api.Service.Project
	(*Service_File)(nil),        // 12: kratos.api.Service.File
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	11, // 9: kratos.api.Service.project:type_name -> kratos.api.Service.Project
	12, // 10: kratos.api.Service.file:type_name -> kratos.api.Service.File
