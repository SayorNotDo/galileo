...
func wireApp(confServer *conf.Server, auth *conf.Auth, confData *conf.Data, logger log.Logger, registry *conf.Registry) (*kratos.App, func(), error) {
	...
	app := newApp(logger, httpServer, rabbitmqServer, registrar)
	return app, func() {
		cleanup()
	}, nil
}
