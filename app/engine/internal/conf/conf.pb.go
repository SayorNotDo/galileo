...
type Service struct {
	...
	Task *Service_Task `protobuf:"bytes,1,opt,name=task,proto3" json:"task,omitempty"`
}
...
func (x *Service) GetTask() *Service_Task {
	if x != nil {
		return x.Task
	}
	return nil
...
func (x *Service_Task) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Service_Task) ProtoMessage() {}

func (x *Service_Task) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Service_Task.ProtoReflect.Descriptor instead.
func (*Service_Task) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Service_Task) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0x5b, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2c, 0x0a, 0x04, 0x74,
	0x61, 0x73, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6b, 0x72, 0x61, 0x74,
	0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x54,
	0x61, 0x73, 0x6b, 0x52, 0x04, 0x74, 0x61, 0x73, 0x6b, 0x1a, 0x22, 0x0a, 0x04, 0x54, 0x61, 0x73,
	...
	0x6e, 0x74, 0x22, 0x7b, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x12, 0x33,
	...
	0x1e, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x16, 0x0a, 0x06, 0x6a, 0x77, 0x74, 0x4b, 0x65,
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6a, 0x77, 0x74, 0x4b, 0x65, 0x79, 0x42,
	0x23, 0x5a, 0x21, 0x67, 0x61, 0x6c, 0x69, 0x6c, 0x65, 0x6f, 0x2f, 0x65, 0x6e, 0x67, 0x69, 0x6e,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Service_Task)(nil),        // 11: kratos.api.Service.Task
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	11, // 9: kratos.api.Service.task:type_name -> kratos.api.Service.Task
