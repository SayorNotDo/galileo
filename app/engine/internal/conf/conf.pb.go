...
type Service struct {
	...
	Management *Service_Management `protobuf:"bytes,1,opt,name=management,proto3" json:"management,omitempty"`
	Docker     *Service_Docker     `protobuf:"bytes,2,opt,name=docker,proto3" json:"docker,omitempty"`
}
...
func (x *Service) GetDocker() *Service_Docker {
	if x != nil {
		return x.Docker
	}
	return nil
...
func (x *Service_Docker) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Service_Docker) ProtoMessage() {}

func (x *Service_Docker) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Service_Docker.ProtoReflect.Descriptor instead.
func (*Service_Docker) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 1}
}

func (x *Service_Docker) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x1a, 0x24, 0x0a, 0x06, 0x44, 0x6f,
	0x63, 0x6b, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	...
	0x4b, 0x65, 0x79, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x61, 0x6c, 0x69, 0x6c, 0x65, 0x6f, 0x2f, 0x65,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Service_Management)(nil),  // 11: kratos.api.Service.Management
	(*Service_Docker)(nil),      // 12: kratos.api.Service.Docker
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	11, // 9: kratos.api.Service.management:type_name -> kratos.api.Service.Management
	12, // 10: kratos.api.Service.docker:type_name -> kratos.api.Service.Docker
