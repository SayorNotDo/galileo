...
var ProviderSet = wire.NewSet(NewData, NewEngineRepo, NewTaskServiceClient, NewRedis, NewRegistrar, NewDiscovery)
...
// NewData .
func NewData(c *conf.Data, tc taskV1.TaskClient, logger log.Logger, redisCli redis.Cmdable) (*Data, func(), error) {
	l := log.NewHelper(log.With(logger, "module", "engine.DataService"))
	cleanup := func() {
		l.Info("closing the data resources")
	}
	return &Data{log: l, tc: tc, redisCli: redisCli}, cleanup, nil
}
