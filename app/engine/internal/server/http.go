...
func NewHTTPServer(c *conf.Server, ac *conf.Auth, engine *service.EngineService, logger log.Logger) *http.Server {
...
func NewWhiteListMatcher() selector.MatchFunc {
	...
	whiteList["/api.engine.v1.Engine/TestEngine"] = struct{}{}
