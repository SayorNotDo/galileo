...
func (meq *MetaEventQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (meq *MetaEventQuery) FirstIDX(ctx context.Context) int64 {
...
func (meq *MetaEventQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (meq *MetaEventQuery) OnlyIDX(ctx context.Context) int64 {
...
func (meq *MetaEventQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (meq *MetaEventQuery) IDsX(ctx context.Context) []int64 {
	ids, err := meq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(metaevent.FieldEventName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.MetaEvent.Query().
//		Select(metaevent.FieldEventName).
//		Scan(ctx, &v)
...
func (meq *MetaEventQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(metaevent.Table, metaevent.Columns, sqlgraph.NewFieldSpec(metaevent.FieldID, field.TypeInt64))
	_spec.From = meq.sql
