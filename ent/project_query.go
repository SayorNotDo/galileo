...
func (pq *ProjectQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (pq *ProjectQuery) FirstIDX(ctx context.Context) uint32 {
...
func (pq *ProjectQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (pq *ProjectQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (pq *ProjectQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (pq *ProjectQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *ProjectQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(project.Table, project.Columns, sqlgraph.NewFieldSpec(project.FieldID, field.TypeUint32))
	_spec.From = pq.sql
